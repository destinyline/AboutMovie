...
<body>
	...
	&nbsp; &nbsp; &nbsp; 
	    ...
	    <form name="form3" method="post" action="save_create.php" enctype="multipart/form-data">
	...
	<div id="content"> 
		...
		TOPIC NAME
		<br>
		<input type="text" name="topic_name" placeholder="name" required/>
		<br>
		<br>
		<br>
		<br>
		UPLOAD POSTER IMAGE
		<br>
    <input type="file" name="fileUpload" id="poster">

		<br>
		<br>
		DESCRIPTION
		<br>
		<textarea name="description_topic" placeholder="write about description" type="text" rows="20" cols="20" wrap="physical"></textarea>
		<br>
		<br>
		<br>
		RATE
		<br>
		<select name="rate_movie">
...
<option value="5">5</option>
		...
		<br>
		<br>
		<input type="submit" name="btn-add" value="Finish" width="50"/>	
		<br>
		<br>
		<br>
		<br>
